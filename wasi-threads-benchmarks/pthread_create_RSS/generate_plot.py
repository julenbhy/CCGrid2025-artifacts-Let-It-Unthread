...
def plot_benchmark(bench, ylabel_text, title_text):
...
benchmarks_info = [
    ('create', 'Time (s)', 'Thread creation time comparison'),
    ('create_rss', 'Max RSS (KB)', 'Thread creation Max RSS comparison')
]

for bench, ylabel_text, title_text in benchmarks_info:
    plot_benchmark(bench, ylabel_text, title_text)
